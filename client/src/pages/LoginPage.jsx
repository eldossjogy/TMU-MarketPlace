                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
                        <div className="relative z-0 w-full mb-5">
                            ...
                            <label htmlFor="email" className="peer-focus:font-medium absolute text-xs sm:text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">TMU Email Address</label>
                            <p className="mt-2">
                        ...
                        <div className="relative z-0 w-full mb-5">
                            ...
                            <label htmlFor="password" className="peer-focus:font-medium absolute text-xs sm:text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Password</label>
                        ...
                        <div className='space-y-4 md:space-y-6'>
                            <button type="submit" className="w-full rounded-full text-white bg-sky-500 hover:bg-sky-600 font-medium text-xs sm:text-sm px-5 py-2.5 text-center">Login</button>
