...
export default function RegisterPage() {
    ...
    return (
        <section className='flex justify-center items-center h-[100vh] bg-neutral-100'>
            <form onSubmit={handleSubmit} className='flex bg-amber-50 shadow-lg rounded-xl border-2 border-amber-200 w-[70%] sm:w-[55%] md:w-[45%] lg:w-[35%] px-8 py-3 flex-wrap space-y-4 justify-center'>
                <h2 className='w-full text-xl text-center'>Logo</h2>
                <section className='w-full space-y-1.5'>
                    <div className='flex-col w-[80%]'>
                        <label htmlFor={"full-name"} className={"block mb-2 text-sm font-medium text-gray-900"}>First Name <span className='text-neutral-400'>(Letters Only)</span></label>
                        <div className='flex flex-row space-x-[6%]'>
                            <input  type="text" name="first-name"
                                className={" bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-[47%] p-2"} 
                    ...
                    <div className='flex-col w-[80%]'>
                        <label htmlFor={"student-num"} className={"block mb-2 text-sm font-medium text-gray-900"}>Student Number <span className='text-neutral-400'>(9 digits)</span></label>
