        ...
        <section className='flex justify-center items-center h-[100vh] bg-neutral-100'>
            <form onSubmit={handleSubmit} className='flex bg-amber-50 shadow-lg rounded-xl border-2 border-amber-200 w-[70%] sm:w-[55%] md:w-[45%] lg:w-[35%] p-8 flex-wrap space-y-4 justify-center'>
                ...
                <section className='w-full space-y-2'>
                    <div className='flex flex-row space-x-[6%] w-[80%]'>
                        <div className='flex-col w-[47%]'>
                            <label htmlFor={"first-name"} className={"block mb-2 text-sm font-medium text-gray-900"}>First Name <span className='text-neutral-400'>(Letters Only)</span></label>
                        ...
                        <div className='flex-col w-[47%]'>
                            <label htmlFor={"last-name"} className={"block mb-2 text-sm font-medium text-gray-900"}>Last Name <span className='text-neutral-400'>(Letters Only)</span></label>
