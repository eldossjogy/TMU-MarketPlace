                                    ...
                                    <tr className={`${isRowSelected(elem) ? 'bg-blue-100 border-white' : 'border-b'}`}>
                                        ...
                                        <td className="px-4 py-3 flex flex-col items-end relative">
                                            ...
                                            {editItemButtons[index] &&
                                                <div className="absolute mt-10 z-50 w-44 bg-white rounded divide-y divide-gray-100 shadow">
                ...
                <div className="relative p-4 w-full max-w-2xl max-h-full md:max-h-[75%] z-100 overflow-y-auto scrollbar scrollbar-hide">
                    <div className="relative p-4 bg-white rounded-lg shadow sm:p-5">
                        <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                            <h3 className="text-lg font-semibold text-gray-900">Assign admin role to a new user</h3>
						...
						/>
                        <button onClick={() => postReqAsAdmin(formData)} className="mt-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add User</button>
            ...
            <div className="overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-full max-h-full bg-black bg-opacity-50">
                <div className="relative p-4 w-full max-w-xl md:max-w-[40%] max-h-full md:max-h-[70%] overflow-y-auto scrollbar scrollbar-hide">
                    ...
                    <div className="relative p-4 bg-white rounded-lg shadow sm:p-5">
                        ...
                        <dl>
                            <dt className="mb-2 font-semibold leading-none text-gray-900">id</dt>
                            <dd className="mb-4 font-light text-gray-500 sm:mb-5">{previewListing.id}</dd>
                            <dt className="mb-2 font-semibold leading-none text-gray-900">User ID</dt>
                            <dd className="mb-4 font-light text-gray-500 sm:mb-5">{previewListing.user_id}</dd>
                            <dt className="mb-2 font-semibold leading-none text-gray-900">Admin role assigned at</dt>
            ...
            <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-full max-h-full bg-black bg-opacity-50">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div className="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                        ...
                        <p className="mb-4 text-gray-500">{selectedItems.length > 1 ? `Are you sure you want to revoke admin privileges from the ${selectedItems.length} users?` : `Are you sure you want to revoke admin privileges from user "${selectedItems[0].profile.name}"?`}</p>
                        <div className="flex justify-center items-center space-x-4">
                            <button onClick={() => {deleteAdminPriv(selectedItems)}} className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300">Yes, I'm sure</button>
            ...
            <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-full max-h-full bg-black bg-opacity-50">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div className="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                        ...
                        <p className="mb-4 text-gray-500">{`Are you sure you want to revoke admin privileges from user "${singleDeleteListing[0].profile.name}"?`}</p>
                        <div className="flex justify-center items-center space-x-4">
                            <button onClick={() => {deleteAdminPriv(singleDeleteListing)}} className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300">Yes, I'm sure</button>
