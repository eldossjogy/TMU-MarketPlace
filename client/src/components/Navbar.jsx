...
export default function Navbar() {
    ...
    useEffect(() => {
        const authOptions = [{name: 'Post New Ad', url: '/my-market/create-listing'}, {name: 'My Market', url: '/my-market'},{name: 'My Profile', url: '/my-market/settings'},{name: 'Your Inbox', url: '/my-market/inbox'},{name: 'Saved Listings', url: '/my-market/saved'},{name: 'Log out', url: '/logout'}];
